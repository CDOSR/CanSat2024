...
\begin{figure}[htbp]
\centering
\includegraphics[width=\linewidth]{images/img_Block_Diagram_2023}
...
\begin{wrapfigure}{r}{0.5\textwidth}
    \centering
    \includegraphics[width=7.5cm]{images/img_Cansat_RTOS}
...
\begin{wrapfigure}{l}{0.26\textwidth}
    \centering
    \includegraphics[width=4cm]{images/img_canopy2}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=11.7cm]{images/Gantt}
    %\caption{\small{CDOSR Gantt Chart for CanSat 2023.}}
    \label{fig:gantt}
\end{figure}
