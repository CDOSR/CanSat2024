...
\cansattitle{Critical Design Report}{images/img_CDOSR.png}{images/img_CANSAT_RO.png}
...
\newpage
\input{section_0/section_0}
\input{section_1/section_1}
\input{section_2/section_2}
\input{section_3/section_3}
...
\begin{enumerate}[]
    \item \textbf{Can Design and Manufacturing} - in progress
    \begin{itemize}
    \item Can design in 3D - In progress
        \begin{itemize}
            \item models for main IC
            \item power board
            \item sensor board
            \item can assembly model
        \end{itemize}
    \item Parts (Acquisition) - in progress
    \end{itemize}    
    \item \textbf{PCB Design and Manufacturing} - in progress
    \begin{itemize}
        \item PCB Design
        \begin{itemize}
            \item Power Board Design - in progress
            \item Sensor Board Design  - in progress
        \end{itemize}
        \item PCB Manufacturing
        \begin{itemize}
            \item Power Board - scheduled
            \item Sensor Board - scheduled
        \end{itemize}    
    \end{itemize}
    \item \textbf{Can Software}:
    \begin{itemize}
        \item {Mission Software}
        \begin{itemize}
            \item Sensor integration - scheduled
            \item TX/RX between devices - scheduled
            \item New mainboard software integration - scheduled
            \item Base station software - scheduled
        \end{itemize}
        \item {Post Mission Software}
        \begin{itemize}
            \item Data aggregation - scheduled
            \item Data analysis - scheduled
            \item Reporting - scheduled
        \end{itemize}
    \end{itemize}
    \item \textbf{Testing} - scheduled
    \begin{itemize}
        \item Recovery system
        \begin{itemize}
            \item Parachute - in progress, partly done
            \item Locator for Can - scheduled
        \end{itemize}
        \begin{itemize}
            \item Sensor reading - done
            \item Can-Base transmission - scheduled
            \item Base station - scheduled
        \end{itemize}
        \item Hardware
        \begin{itemize}
            \item Electronics - scheduled
            \item Batteries - scheduled
            \item Receiver Antenna - scheduled
        \end{itemize}
        \item Structure
        \begin{itemize}
            \item Crashproof - scheduled
        \end{itemize}
    \end{itemize}
\end{enumerate}
...
\section{Payload  -  software design}\label{AE22}
\begin{figure}[htbp]
    \centering
    \includegraphics[width=13cm]{images/Soft_flowchart}
